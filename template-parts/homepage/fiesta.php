                    ...
                    <div class="flexbox">
                        ...
                        <div class="wrapper-content fiesta">
                            <p>
                                ...
                                Day *
                                στο απόλυτο μεξικάνικο της πόλης
                            </p>
                            <div class="join"></div>
                            <button type="button" class="btn btn-danger">ΛΑΒΕ ΜΕΡΟΣ ΣΤΟΝ ΔΙΑΓΩΝΙΣΜΟ</button>
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="wp-content/themes/dos/images/photo_events.png"
                                 alt="First slide">
                        </div>
